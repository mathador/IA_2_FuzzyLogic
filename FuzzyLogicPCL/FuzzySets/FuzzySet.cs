...
public class FuzzySet
{
    ...
    public static bool operator ==(FuzzySet fs1, FuzzySet fs2)
    {
    ...
    {
        FuzzySet result = new(fs.Min, fs.Max);
    ...
    private static double InterpolatedValueBetweenTwoPoints(double xValue, Point2D before, Point2D after)
    {
    ...
    private static bool endOfList1;
    private static bool endOfList2;
    ...
    private static bool IsFirstPoint(Point2D oldPt)
    {
        return oldPt == null;
    }
