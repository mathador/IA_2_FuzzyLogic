...
class ZoomGps
{
    public static void Main(string[] args)
    {
        ...
        FuzzySystem system = new("Gestion du zoom GPS");
        ...
        LinguisticVariable distance = new("Distance", 0, 500000);
        ...
        LinguisticVariable vitesse = new("Vitesse", 0, 200);
        ...
        LinguisticVariable zoom = new("Zoom", 0, 5);
