...
class Test
{
    ...
    public static void Main(string[] args)
    {
        ...
        FuzzySet fz = new(0, 100);
        Point2D pt1 = new(0, 1);
        Point2D pt2 = new(50, 0);
        Point2D pt3 = new(100, 0);
        fz.Add(pt3);
        fz.Add(pt2);
        fz.Add(pt1);

        TriangularFuzzySet tifz = new(0, 100, 30, 50, 70);
        FuzzySet itifz = !tifz;
        TrapezoidalFuzzySet trfz = new(0, 100, 30, 50, 70, 80);
        TrapezoidalFuzzySet trfz2 = new(0, 100, 30, 50, 70, 80);
        LeftFuzzySet lfz = new(0, 100, 30, 50);
        RightFuzzySet rfz = new(0, 100, 70, 80);
